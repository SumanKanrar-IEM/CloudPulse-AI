...
import {
    UtilizationServiceInterface
} from './utilization.serviceInterface';
...
export class UtilizationService extends BaseService implements UtilizationServiceInterface {
