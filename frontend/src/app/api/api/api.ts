...
export const APIS = [AccountsService, BudgetOverrunsService, BudgetsService, ComplianceService, FindingsService, IamHygieneService, IdentityService, OwnershipService, ResourcesService, RulesService, SdasService, SpendService, SystemService, UtilizationService];
