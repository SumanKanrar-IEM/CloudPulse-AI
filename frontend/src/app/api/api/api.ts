...
export const APIS = [AccountsService, ComplianceService, FindingsService, IdentityService, OwnershipService, ResourcesService, RulesService, SdasService, SystemService];
