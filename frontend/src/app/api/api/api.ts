...
export const APIS = [AccountsService, BudgetOverrunsService, BudgetsService, ComplianceService, FindingsService, IamHygieneService, IdentityService, InsightsService, OwnershipService, ResourcesService, RulesService, SdasService, SpendService, SystemService, UtilizationService];
