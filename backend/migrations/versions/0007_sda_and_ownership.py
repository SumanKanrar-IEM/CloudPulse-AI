...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("tag_values", postgresql.JSONB(), server_default=sa.text("'{}'::jsonb"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.PrimaryKeyConstraint("id", name="pk_sda"),
        sa.ForeignKeyConstraint(["tenant_id"], ["tenant.id"], name="fk_sda_tenant_id_tenant", ondelete="RESTRICT"),
    ...
    op.create_table(
        ...
        sa.Column("confidence", postgresql.ENUM(name="owner_confidence", create_type=False), nullable=False),
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenant.id"], name="fk_resource_owner_tenant_id_tenant", ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(["resource_id"], ["resource.id"], name="fk_resource_owner_resource_id_resource", ondelete="CASCADE"),
