...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("trigger", postgresql.ENUM(name="scan_trigger", create_type=False), nullable=False),
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenant.id"], name="fk_scan_tenant_id_tenant", ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(["cloud_account_id"], ["cloud_account.id"], name="fk_scan_cloud_account_id_cloud_account", ondelete="CASCADE"),
    )
