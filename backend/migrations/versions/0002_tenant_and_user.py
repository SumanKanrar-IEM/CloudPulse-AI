...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="tenant_status", create_type=False), server_default="active", nullable=False),
    ...
    op.execute(f"INSERT INTO tenant (name) VALUES ('{SEEDED_TENANT_NAME}')")
