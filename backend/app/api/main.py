...
from app.api.routers import accounts, health, me
...
def create_app() -> FastAPI:
    ...
    # Routers added by later specs: findings/rules/sda (003), dashboard reads (004),
    # cost (005), agent-facing reads (006, FR-056).
