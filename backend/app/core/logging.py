...
class RedactingFormatter(LambdaPowertoolsFormatter):
    ...
    def serialize(self, log: Any) -> str:
        # Signature widened to match LambdaPowertoolsFormatter.serialize, which accepts
        # dict[str, Any] | PowertoolsLogRecord. Narrowing it would be an LSP violation.
        return str(super().serialize(redact(log)))
