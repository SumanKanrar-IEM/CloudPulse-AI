...
BANNED_PACKAGES: dict[str, str] = {
    ...
    "langchain": "agent framework, non-AWS inference by default (see docstring)",
    "langchain-core": "agent framework, non-AWS inference by default (see docstring)",
    "langchain-community": "agent framework, non-AWS inference by default (see docstring)",
    "langgraph": "agent framework, non-AWS inference by default (see docstring)",
    "llama-index": "agent framework, non-AWS inference by default (see docstring)",
    "haystack-ai": "agent framework, non-AWS inference by default (see docstring)",
    "crewai": "agent framework, non-AWS inference by default (see docstring)",
    "autogen": "agent framework, non-AWS inference by default (see docstring)",
    "semantic-kernel": "agent framework, non-AWS inference by default (see docstring)",
    "@langchain/core": "agent framework, non-AWS inference by default (see docstring)",
